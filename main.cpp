...
void wishme(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Tejas"<<endl;
        string phrase = "Good Morning Tejas";
        ...
        cout<< "Good Afternoon Tejas"<<endl;
        string phrase = "Good Afternoon Tejas";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Tejas"<<endl;
        string phrase = "Good Evening Tejas";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(strcmp(password, "poco")==0){
            cout<<"\n<==================================================================================================>\n\n";
            wishme();
            do{
                cout<<"\n<==================================================================================================>\n\n";
                cout<<endl<<"How can i help you Tejas...."<<endl<<endl;
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my master Tejas!!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master Tejas";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
